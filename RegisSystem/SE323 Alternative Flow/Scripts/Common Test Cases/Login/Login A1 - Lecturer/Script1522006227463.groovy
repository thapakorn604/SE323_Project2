...
WebUI.setText(findTestObject('Page_React App/input_input'), 'lecturer')

WebUI.setText(findTestObject('Page_React App/input_input_1'), 'lecturer')

WebUI.selectOptionByValue(findTestObject('Page_React App/select'), 'Lecturer', true)

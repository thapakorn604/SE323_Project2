...
WebUI.setText(findTestObject('LecturerSeeCourseHistory/input_input'), 'Noppon_coosri@cmu.ac.th')

WebUI.setText(findTestObject('LecturerSeeCourseHistory/input_input_1'), '123456789')

WebUI.selectOptionByValue(findTestObject('LecturerSeeCourseHistory/select_StudentLecturer'), 'Lecturer', true)

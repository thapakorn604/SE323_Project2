...
WebUI.setText(findTestObject('StudentWithDrawCourse/input_input'), 'thanawat_lukuan@cmu.ac.th')

WebUI.setText(findTestObject('StudentWithDrawCourse/input_input_1'), '1234')

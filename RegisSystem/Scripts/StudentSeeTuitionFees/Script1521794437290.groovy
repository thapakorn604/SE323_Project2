...
WebUI.setText(findTestObject('StudentSeeTuitionFees/input_input'), 'thanawat_lukuan@cmu.ac.th')

WebUI.setText(findTestObject('StudentSeeTuitionFees/input_input_1'), '1234')
